  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-danger-500 text-destructive-foreground hover:bg-danger-400",
        outline:
          "border border-input hover:border-intense text-color-base bg-base hover:text-accent-foreground",
        soft: "bg-primary-200 text-active hover:bg-primary-300",
        secondary:
          "bg-base text-color-base hover:bg-secondary border border-default",
